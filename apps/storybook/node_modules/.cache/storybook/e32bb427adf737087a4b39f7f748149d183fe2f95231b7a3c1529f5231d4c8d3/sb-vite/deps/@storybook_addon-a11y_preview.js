...
var run = async (input = defaultParameters) => {
  let { default: axe } = await import("./axe-ZXHW5LCK.js"), { element = "body", config = {}, options = {} } = input, htmlElement = document.querySelector(element) ?? document.body;
