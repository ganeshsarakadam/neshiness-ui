...
import {
  ...
  wt,
  xP
} from "./chunk-ZSINSL4U.js";
import {
  renderElement,
  unmountElement
} from "./chunk-TZ6QNMWX.js";
import "./chunk-CSV2GX2S.js";
import "./chunk-FL4VCJUN.js";
import "./chunk-PG67ZSQK.js";
import {
  z
} from "./chunk-XR7MR5AR.js";
import {
  gt,
  yn
} from "./chunk-WWY3SS3V.js";
import "./chunk-F2TZRQKA.js";
import "./chunk-LCGKI7JQ.js";
import {
  require_react
...
// ../../node_modules/.pnpm/@storybook+addon-docs@8.6.14_@types+react@19.1.12_storybook@8.6.14_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@8.6.14_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.6.14_prettier@3.6.2_/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-QUH7WE3G.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-Z53EJBE4.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-JJSHACPD.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-BOOLWH53.js.map
